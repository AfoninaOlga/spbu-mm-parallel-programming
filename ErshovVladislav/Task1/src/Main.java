...
public class Main {
    ...
    private final static String FILE_NAME_WITH_INITIAL_ARRAY = "../resources/initialArray.txt";
    ...
    public static void main(String[] args) {
        ...
        if (rank == 0) {
            ...
            for (int i = 1; i < size; i++) {
                ...
                MPI.COMM_WORLD.Recv(receiveBufferBoundaryNumbers, 0, receiveBufferBoundaryNumbersSize[i], MPI.INT, i, 12);
        ...
        for(int i = 0; i < size; i++) {
            if (rank < i) {
                ...
                MPI.COMM_WORLD.Recv(receiveBufferSequenceNumbers, 0, receiveSequenceNumbersSizes.get(i), MPI.INT, i, 32);
        ...
        // Print sorted array
        printNodeArray("Answer:", finalNodeNumbers, rank, size);
     ...
     *
     * @throws IllegalArgumentException if fileName is null, blank or empty or the file with the given fileName cannot be written to
     */
    public static void fillInitialArray(String fileName) throws IllegalArgumentException {
        if (fileName == null) {
            ...
            throw new IllegalArgumentException("The given fileName must not be blank or empty");
        }
        ...
        try(FileWriter writer = new FileWriter(fileName, false)) {
            ...
            throw new IllegalArgumentException("The file with the given fileName cannot be written to");
        }
    }
     ...
     *
     * @throws IllegalArgumentException if nodeArray is null, nodeArray contain null values or size < 1
     */
    public static List<Integer> getBoundaryNumbers(List<Integer> nodeArray, int size) throws IllegalArgumentException {
        if (nodeArray == null) {
            throw new IllegalArgumentException("The given nodeArray must not be null");
        } else if (size < 1) {
            throw new IllegalArgumentException("The given size must be greater than one");
        } else if (nodeArray.contains(null)) {
            throw new IllegalArgumentException("In the given nodeArray must not contain null values");
     ...
     *
     * @throws IllegalArgumentException if allBoundaryNumbers is null, allBoundaryNumbers contain null values, size < 1, rank < 0 or rank >= size
     */
    public static List<Integer> computeLeadingNumbers(List<Integer> allBoundaryNumbers, int rank, int size) throws IllegalArgumentException {
        if (allBoundaryNumbers == null) {
            ...
            throw new IllegalArgumentException("In the given allBoundaryNumbers must not contain null values");
        } else if (rank < 0) {
            throw new IllegalArgumentException("The given rank must be greater than zero");
        } else if (size < 1) {
            throw new IllegalArgumentException("The given size must be greater than one");
        } else if (rank >= size) {
            throw new IllegalArgumentException("The given rank must be less than given size");
        } else if (rank != 0) {
            return new ArrayList<>();
        }
        ...
        for (int i = 0; i < size - 1; i++) {
            ...
            if (index > allBoundaryNumbers.size() - 1 || index < 0) break;
     ...
     */
    public static List<List<Integer>> getNodeBorders(List<Integer> initialArray, int size) throws IllegalArgumentException {
        if (initialArray == null) {
            throw new IllegalArgumentException("The given initialArray must not be null");
        } else if (size < 1) {
            throw new IllegalArgumentException("The given size must be greater than one");
        }
     ...
     *
     * @throws IllegalArgumentException if fileName is null, blank or empty or file with the given fileName not found
     */
    public static List<Integer> getInitialArrayFromFile(String fileName) throws IllegalArgumentException {
        ...
        try (Scanner scanner = new Scanner(file)) {
            ...
            throw new IllegalArgumentException("File with the given fileName not found");
        }
     ...
     *
     * @throws IllegalArgumentException if nodeArray or leadingNumbers is null, size < 1
     */
    public static List<List<Integer>> getSentSequencesNumbers(List<Integer> nodeArray, List<Integer> leadingNumbers, int size) throws IllegalArgumentException {
        if (nodeArray == null) {
            throw new IllegalArgumentException("The given nodeArray must not be null");
        } else if (leadingNumbers == null) {
            throw new IllegalArgumentException("The given leadingNumbers must not be null");
        } else if (size < 1) {
            throw new IllegalArgumentException("The given size must be greater than one");
        }
     ...
     * @param size  number of nodes
     *
     * @throws IllegalArgumentException if title is null, array is null, size < 1, rank < 0 or rank >= size
     */
    private static void printNodeArray(String title, List<Integer> array, int rank, int size) throws IllegalArgumentException {
        if (title == null) {
            throw new IllegalArgumentException("The given title must not be null");
        } else if (array == null) {
            throw new IllegalArgumentException("The given array must not be null");
        } else if (rank < 0) {
            throw new IllegalArgumentException("The given rank must be greater than zero");
